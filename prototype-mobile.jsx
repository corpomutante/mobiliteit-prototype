...
const SCREENS = {
  ...
  journeyOverviewB: { title: "Journey · overview (RE11+22)", render: () => <TrainJourneyMapOverviewB /> },
    ...
    <div style={{ position: "fixed", inset: 0, display: "flex", alignItems: "center", justifyContent: "center", background: "#000", overflow: "hidden" }}>
      <div style={{ width: contentW * fit, height: contentH * fit, position: "relative" }}>
        <div style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 10, font: "var(--t-sub-em)", fontSize: 13, color: "var(--fg-2)", height: TOOLBAR_H }}>
            <span style={{
              display: "inline-flex", alignItems: "center", gap: 6, padding: "6px 12px", borderRadius: 999,
              background: "var(--bg-elevated)", boxShadow: "var(--sh-1)"
            }}>
            ...
            <button
              ...
              style={{
                ...
                border: 0, background: "var(--bg-elevated)", boxShadow: "var(--sh-1)", color: "var(--fg-2)",
                font: "var(--t-sub-em)", fontSize: 13, cursor: "pointer"
              }}>
            ...
            <button
              ...
              style={{
                display: "inline-flex", alignItems: "center", gap: 6, height: 32, padding: "0 12px", borderRadius: 999,
                border: 0, background: stack.length <= 1 ? "var(--bg-elevated)" : "var(--ac-secondary-soft)",
                color: stack.length <= 1 ? "var(--fg-4)" : "var(--ac-secondary)",
                boxShadow: "var(--sh-1)", font: "var(--t-sub-em)", fontSize: 13,
